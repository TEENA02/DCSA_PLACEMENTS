...
import { Data_23, student, company } from "../Data/Data_23";
ChartJs.register(
  CategoryScale,
  LinearScale,
  BarElement,
  ...
  return (
    ...
    <section className="flex flex-col md:flex-row justify-between items-center md:items-start mt-2">
      <div style={{ width: "100%", maxWidth: "600px", height: "400px" }} className="mb-6 md:mb-0">
        <Bar options={options} data={Data_23} />
      </div>
    ...
    <section className="mt-10">
      <h4 className="text-2xl text-gray-900 font-bold md:text-3xl">
        Total Companies Visited: 37
      </h4>
      <p className="mt-4 text-gray-600">
        We are thrilled to announce that 37 companies visited our DCSA
